...
public class PesticideActivity extends AppCompatActivity {
    ...
    private void fetchServices() {
        ...
        servicesRef.whereEqualTo("business_type", "Pesticide").get().addOnSuccessListener(queryDocumentSnapshots -> {
            progressBar.setVisibility(View.GONE); // Hide ProgressBar when data is fetched
            recyclerView.setVisibility(View.VISIBLE); // Show RecyclerView

            if (queryDocumentSnapshots.isEmpty()) {
                Log.e("Firebase", "No Pesticide services found in Firestore.");
            ...
            for (DocumentSnapshot doc : queryDocumentSnapshots) {
                ...
                Log.d("Firebase", "Pesticide Service Found: " + service_name);
                    ...
                    for (StorageReference fileRef : listResult.getItems()) {
                        fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            if (imageUrls.size() == listResult.getItems().size()) {
                                ...
                                Log.d("Firebase", "Added Pesticide service to list: " + service_name);
                            }
